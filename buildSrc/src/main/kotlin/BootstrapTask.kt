    ...
    private fun getArtifacts(): Array<JsonBuilder> {
        ...
        project.configurations["runtimeClasspath"].resolvedConfiguration.resolvedArtifacts.forEach {
            ...
            if (it.file.name.contains("runelite-client") ||
                ...
                path = "https://raw.githubusercontent.com/melxin/devious-hosting/master/${type}/${it.file.name}"
        ...
        artifacts.add(JsonBuilder(
                "name" to cjar.name,
                "path" to "https://raw.githubusercontent.com/melxin/devious-hosting/master/${type}/${cjar.name}",
                "size" to cjar.length(),
                "hash" to sha
        ))
